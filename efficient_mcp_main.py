...
import a2c_ppo_acktr.actors as atr
import a2c_ppo_acktr.critics as crt
import a2c_ppo_acktr.agents as agents
...
def main():
    ...
    num_primitives = 3  # hardcoded
    abstraction_interval = 1  # hardcoded
